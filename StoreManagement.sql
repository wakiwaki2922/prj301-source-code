...
select B.orderID,B.userID,A.name, B.total,B.dateOrderNew from Accounts A,Orders B where A.userID = B.userID



UPDATE Products SET quantity = 20, price = 10000 WHERE productID = 1
